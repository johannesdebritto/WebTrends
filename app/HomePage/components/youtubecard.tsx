  ...
  return (
    <>
      ...
      >
        ...
        <AnimatePresence>
          {isHovered && (
            <motion.div initial={{ x: "100%" }} animate={{ x: 0 }} exit={{ x: "100%" }} transition={{ duration: 0.4 }} className="absolute inset-0 bg-gradient-to-r from-red-600 via-red-500 to-orange-500 z-0" aria-hidden="true" />
          )}
        </AnimatePresence>
