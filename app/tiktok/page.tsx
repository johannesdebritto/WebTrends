...
import { fnbtiktok } from "./datatiktok/fnbtiktok";
import { gametiktok } from "./datatiktok/gametiktok";
import { olahragatiktok } from "./datatiktok/olahragatiktoks";
export default function TiktokPage() {
  const fullText = "TikTok Trends";
      ...
      <main className="flex-grow flex flex-col items-center justify-start pt-20 px-4 font-sans pb-16">
        ...
        <div className="flex flex-wrap justify-center gap-8 w-full max-w-6xl mt-6">
          <div className="flex flex-col gap-8 flex-1 min-w-[300px]">
            <TrendsTable title="F&B" data={fnbtiktok} />
            <TrendsTable title="Game" data={gametiktok} />
          </div>
          <div className="flex-1 min-w-[300px]">
            <TrendsTable title="Olahraga" data={olahragatiktok} />
          </div>
        </div>
      </main>
